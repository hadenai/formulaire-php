...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST) )
{
    ...
    if ($error === false){
        header ('Location: cible_envoi.php');
    }
}
    ...
    <div class="row">
        <form action="" method="POST" class="col-12">
            <div class="form-group">
                ...
                <input name="first-name" type="text" id="first-name" class="form-control <?php if (isset($firstNameError)) echo 'is-invalid'?> ">
            ...
            <div class="form-group">
                ...
                <input name="last-name" type="text" id="last-name" class="form-control <?php if (isset($lastNameError)) echo 'is-invalid'?> ">
            ...
            <div class="form-group">
                ...
                <input name="email" type="text" id="email" class="form-control <?php if (isset($emailError)) echo 'is-invalid'?> ">
